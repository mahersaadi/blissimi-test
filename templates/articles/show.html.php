...
<?php if (count($commentaires) === 0) : ?>
    <h2>Il n'y a pas encore de commentaires pour cet item ... SOYEZ LE PREMIER ! :D</h2>
<?php else : ?>
    ...
    <?php foreach ($commentaires as $commentaire) : ?>
        ...
        <a href="index.php?controller=commentaire&task=delete&id=<?= $commentaire['id'] ?>" onclick="return window.confirm(`Êtes vous sûr de vouloir supprimer ce commentaire ?!`)">Supprimer</a>
    <?php endforeach ?>
<?php endif ?>

<form action="index.php?controller=commentaire&task=insert" method="POST">
